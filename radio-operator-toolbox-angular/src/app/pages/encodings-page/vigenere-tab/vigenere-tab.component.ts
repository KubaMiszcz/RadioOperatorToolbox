...
import { ALPHABET_EN, ALPHABET_PL } from 'src/assets/app-constants';

@Component({
  selector: 'app-vigenere-tab',
  templateUrl: './vigenere-tab.component.html',
  styleUrls: ['./vigenere-tab.component.scss'],
})
export class VigenereTabComponent {
  textDecoded = 'abc';
  textEncoded = '';
